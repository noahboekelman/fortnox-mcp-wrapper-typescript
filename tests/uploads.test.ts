import fs from 'fs';
import type { ResponseLike } from 'fortnox-mcp-wrapper/internal/to-file';
import { toFile } from 'fortnox-mcp-wrapper/core/uploads';
...
describe('missing File error message', () => {
  ...
  test('is thrown', async () => {
    const uploads = await import('fortnox-mcp-wrapper/core/uploads');
    await expect(
