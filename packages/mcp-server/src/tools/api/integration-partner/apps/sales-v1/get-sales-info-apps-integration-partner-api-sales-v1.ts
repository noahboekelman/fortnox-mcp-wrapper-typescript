...
export const metadata: Metadata = {
  ...
  tags: [],
  httpMethod: 'get',
  httpPath: '/api/integration-partner/apps/sales-v1/{appId}',
  operationId: 'getAppSalesForSingleApp',
};

export const tool: Tool = {
  name: 'get_sales_info_apps_integration_partner_api_sales_v1',
  description:
...
export const handler = async (client: FortnoxMcpWrapper, args: Record<string, unknown> | undefined) => {
  ...
  try {
    return asTextContentResult(
      await maybeFilter(jq_filter, await client.api.integrationPartner.apps.salesV1.getSalesInfo(appId)),
    );
  } catch (error) {
