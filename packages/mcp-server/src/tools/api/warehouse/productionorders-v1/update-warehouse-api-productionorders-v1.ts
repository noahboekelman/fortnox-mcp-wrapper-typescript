...
export const metadata: Metadata = {
  ...
  tags: [],
  httpMethod: 'put',
  httpPath: '/api/warehouse/productionorders-v1/{id}',
  operationId: 'update_5',
};

export const tool: Tool = {
  name: 'update_warehouse_api_productionorders_v1',
  description:
  ...
  inputSchema: {
    ...
    required: ['path_id', 'productionState', 'quantity', 'startDate'],
    $defs: {
      warehouse_package_item: {
        type: 'object',
        properties: {
...
export const handler = async (client: FortnoxMcpWrapper, args: Record<string, unknown> | undefined) => {
  ...
  try {
    return asTextContentResult(
      await maybeFilter(jq_filter, await client.api.warehouse.productionordersV1.update(id, body)),
    );
  } catch (error) {
