...
export const metadata: Metadata = {
  ...
  tags: [],
  httpMethod: 'put',
  httpPath: '/api/warehouse/stocktransfer-v1/{id}',
  operationId: 'update_4',
};

export const tool: Tool = {
  name: 'update_warehouse_api_stocktransfer_v1',
  description:
...
export const handler = async (client: FortnoxMcpWrapper, args: Record<string, unknown> | undefined) => {
  ...
  try {
    return asTextContentResult(
      await maybeFilter(jq_filter, await client.api.warehouse.stocktransferV1.update(id, body)),
    );
  } catch (error) {
