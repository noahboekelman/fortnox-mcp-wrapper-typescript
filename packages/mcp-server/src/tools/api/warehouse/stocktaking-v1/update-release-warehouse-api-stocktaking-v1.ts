...
export const metadata: Metadata = {
  ...
  tags: [],
  httpMethod: 'put',
  httpPath: '/api/warehouse/stocktaking-v1/{id}/release',
  operationId: 'release_2',
};

export const tool: Tool = {
  name: 'update_release_warehouse_api_stocktaking_v1',
  description:
...
export const handler = async (client: FortnoxMcpWrapper, args: Record<string, unknown> | undefined) => {
  ...
  const response = await client.api.warehouse.stocktakingV1.updateRelease(id).asResponse();
