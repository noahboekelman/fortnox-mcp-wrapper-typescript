...
export const metadata: Metadata = {
  ...
  tags: [],
  httpMethod: 'post',
  httpPath: '/api/warehouse/stocktaking-v1/{id}/addrows',
  operationId: 'addStockTakingRowsByFilter',
};

export const tool: Tool = {
  name: 'addrows_warehouse_api_stocktaking_v1',
  description:
    "When using this tool, always use the `jq_filter` parameter to reduce the response size and improve performance.\n\nOnly omit if you're sure you don't need the data.\n\n<p>\n Add all matching candidate rows to a stock taking, as specified by filters.\n\n# Response Schema\n```json\n{\n  $ref: '#/$defs/stocktaking_v1_addrows_response',\n  $defs: {\n    stocktaking_v1_addrows_response: {\n      type: 'integer'\n    }\n  }\n}\n```",
  inputSchema: {
    type: 'object',
    properties: {
      id: {
...
export const handler = async (client: FortnoxMcpWrapper, args: Record<string, unknown> | undefined) => {
  ...
  try {
    return asTextContentResult(
      await maybeFilter(jq_filter, await client.api.warehouse.stocktakingV1.addrows(id, body)),
    );
  } catch (error) {
