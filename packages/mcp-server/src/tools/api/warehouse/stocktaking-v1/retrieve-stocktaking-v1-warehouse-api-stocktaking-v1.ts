...
export const tool: Tool = {
  name: 'retrieve_stocktaking_v1_warehouse_api_stocktaking_v1',
  description:
...
export const handler = async (client: FortnoxMcpWrapper, args: Record<string, unknown> | undefined) => {
  ...
  try {
    return asTextContentResult(
      await maybeFilter(jq_filter, await client.api.warehouse.stocktakingV1.retrieveStocktakingV1(body)),
    );
  } catch (error) {
