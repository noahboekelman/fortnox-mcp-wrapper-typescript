...
export const metadata: Metadata = {
  ...
  tags: [],
  httpMethod: 'put',
  httpPath: '/api/warehouse/deliveries-v1/outbounddeliveries/{id}/release',
  operationId: 'release_1',
};

export const tool: Tool = {
  name: 'update_release_deliveries_v1_warehouse_api_outbounddeliveries',
  description:
...
export const handler = async (client: FortnoxMcpWrapper, args: Record<string, unknown> | undefined) => {
  ...
  const response = await client.api.warehouse.deliveriesV1.outbounddeliveries.updateRelease(id).asResponse();
