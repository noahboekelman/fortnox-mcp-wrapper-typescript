...
export const metadata: Metadata = {
  ...
  tags: [],
  httpMethod: 'get',
  httpPath: '/api/warehouse/purchaseorders-v1/{id}/matches',
  operationId: 'getMatchedDocuments_1',
};

export const tool: Tool = {
  name: 'retrieve_matches_warehouse_api_purchaseorders_v1',
  description:
...
export const handler = async (client: FortnoxMcpWrapper, args: Record<string, unknown> | undefined) => {
  ...
  try {
    return asTextContentResult(
      await maybeFilter(jq_filter, await client.api.warehouse.purchaseordersV1.retrieveMatches(id)),
    );
  } catch (error) {
