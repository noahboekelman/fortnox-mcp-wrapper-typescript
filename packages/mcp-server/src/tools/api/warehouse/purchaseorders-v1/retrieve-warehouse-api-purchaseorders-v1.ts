...
export const metadata: Metadata = {
  ...
  tags: [],
  httpMethod: 'get',
  httpPath: '/api/warehouse/purchaseorders-v1/{id}',
  operationId: '1_get_17',
};

export const tool: Tool = {
  name: 'retrieve_warehouse_api_purchaseorders_v1',
  description:
...
export const handler = async (client: FortnoxMcpWrapper, args: Record<string, unknown> | undefined) => {
  ...
  try {
    return asTextContentResult(
      await maybeFilter(jq_filter, await client.api.warehouse.purchaseordersV1.retrieve(id, body)),
    );
  } catch (error) {
