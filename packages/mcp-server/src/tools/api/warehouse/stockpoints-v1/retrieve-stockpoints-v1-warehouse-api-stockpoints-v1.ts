...
export const tool: Tool = {
  name: 'retrieve_stockpoints_v1_warehouse_api_stockpoints_v1',
  description:
...
export const handler = async (client: FortnoxMcpWrapper, args: Record<string, unknown> | undefined) => {
  ...
  try {
    return asTextContentResult(
      await maybeFilter(jq_filter, await client.api.warehouse.stockpointsV1.retrieveStockpointsV1(body)),
    );
  } catch (error) {
