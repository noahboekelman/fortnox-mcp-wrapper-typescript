...
export const metadata: Metadata = {
  ...
  tags: [],
  httpMethod: 'get',
  httpPath: '/api/warehouse/stockpoints-v1/multi',
  operationId: 'getMany_3',
};

export const tool: Tool = {
  name: 'retrieve_multi_warehouse_api_stockpoints_v1',
  description:
...
export const handler = async (client: FortnoxMcpWrapper, args: Record<string, unknown> | undefined) => {
  ...
  try {
    return asTextContentResult(
      await maybeFilter(jq_filter, await client.api.warehouse.stockpointsV1.retrieveMulti(body)),
    );
  } catch (error) {
