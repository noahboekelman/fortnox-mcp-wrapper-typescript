...
export const metadata: Metadata = {
  ...
  tags: [],
  httpMethod: 'put',
  httpPath: '/3/contracts/{DocumentNumber}/increaseinvoicecount',
  operationId: 'increaseinvoicecount',
};

export const tool: Tool = {
  name: 'increase_invoice_count_number_3_contracts',
  description:
...
export const handler = async (client: FortnoxMcpWrapper, args: Record<string, unknown> | undefined) => {
  ...
  try {
    return asTextContentResult(
      await maybeFilter(jq_filter, await client.number3.contracts.increaseInvoiceCount(DocumentNumber)),
    );
  } catch (error) {
