...
export const metadata: Metadata = {
  ...
  tags: [],
  httpMethod: 'put',
  httpPath: '/3/offers/{DocumentNumber}/createorder',
  operationId: 'createorder',
};

export const tool: Tool = {
  name: 'create_order_number_3_offers',
  description:
...
export const handler = async (client: FortnoxMcpWrapper, args: Record<string, unknown> | undefined) => {
  ...
  try {
    return asTextContentResult(
      await maybeFilter(jq_filter, await client.number3.offers.createOrder(DocumentNumber)),
    );
  } catch (error) {
