...
export const metadata: Metadata = {
  ...
  tags: [],
  httpMethod: 'put',
  httpPath: '/3/offers/{DocumentNumber}/createinvoice',
  operationId: 'createinvoice_1',
};

export const tool: Tool = {
  name: 'create_invoice_number_3_offers',
  description:
...
export const handler = async (client: FortnoxMcpWrapper, args: Record<string, unknown> | undefined) => {
  ...
  try {
    return asTextContentResult(
      await maybeFilter(jq_filter, await client.number3.offers.createInvoice(DocumentNumber)),
    );
  } catch (error) {
