...
export const metadata: Metadata = {
  ...
  tags: [],
  httpMethod: 'get',
  httpPath: '/3/offers/{DocumentNumber}/preview',
  operationId: 'preview_2',
};

export const tool: Tool = {
  name: 'preview_number_3_offers',
...
export const handler = async (client: FortnoxMcpWrapper, args: Record<string, unknown> | undefined) => {
  ...
  return asBinaryContentResult(await client.number3.offers.preview(DocumentNumber).asResponse());
};
