...
export const metadata: Metadata = {
  ...
  tags: [],
  httpMethod: 'put',
  httpPath: '/3/invoices/{DocumentNumber}/externalprint',
  operationId: 'externalPrint',
};

export const tool: Tool = {
  name: 'set_sent_number_3_invoices',
...
export const handler = async (client: FortnoxMcpWrapper, args: Record<string, unknown> | undefined) => {
  ...
  try {
    return asTextContentResult(await client.number3.invoices.setSent(DocumentNumber));
  } catch (error) {
