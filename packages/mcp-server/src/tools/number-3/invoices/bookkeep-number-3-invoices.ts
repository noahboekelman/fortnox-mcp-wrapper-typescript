...
export const metadata: Metadata = {
  ...
  tags: [],
  httpMethod: 'put',
  httpPath: '/3/invoices/{DocumentNumber}/bookkeep',
  operationId: 'bookkeep_1',
};

export const tool: Tool = {
  name: 'bookkeep_number_3_invoices',
...
export const handler = async (client: FortnoxMcpWrapper, args: Record<string, unknown> | undefined) => {
  ...
  try {
    return asTextContentResult(await client.number3.invoices.bookkeep(DocumentNumber));
  } catch (error) {
