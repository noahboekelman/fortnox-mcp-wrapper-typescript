...
export const metadata: Metadata = {
  ...
  tags: [],
  httpMethod: 'get',
  httpPath: '/3/salarytransactions',
  operationId: 'list_35',
};

export const tool: Tool = {
  name: 'list_number_3_salarytransactions',
  description:
    "When using this tool, always use the `jq_filter` parameter to reduce the response size and improve performance.\n\nOnly omit if you're sure you don't need the data.\n\nSupports query-string parameters <b>employeeid</b> and <b>date</b> for filtering the result.\n\n# Response Schema\n```json\n{\n  $ref: '#/$defs/salarytransaction_list_response',\n  $defs: {\n    salarytransaction_list_response: {\n      type: 'object',\n      properties: {\n        SalaryTransactions: {\n          type: 'array',\n          items: {\n            type: 'object',\n            properties: {\n              Date: {\n                type: 'string',\n                format: 'date'\n              },\n              EmployeeId: {\n                type: 'string'\n              },\n              SalaryCode: {\n                type: 'string'\n              },\n              '@url': {\n                type: 'string'\n              },\n              Amount: {\n                type: 'string'\n              },\n              CostCenter: {\n                type: 'string'\n              },\n              Expense: {\n                type: 'string'\n              },\n              Number: {\n                type: 'string'\n              },\n              Project: {\n                type: 'string'\n              },\n              SalaryRow: {\n                type: 'integer'\n              },\n              TextRow: {\n                type: 'string'\n              },\n              Total: {\n                type: 'string'\n              },\n              VAT: {\n                type: 'string'\n              }\n            },\n            required: [              'Date',\n              'EmployeeId',\n              'SalaryCode'\n            ]\n          }\n        }\n      }\n    }\n  }\n}\n```",
  inputSchema: {
    type: 'object',
    properties: {
      date: {
...
export const handler = async (client: FortnoxMcpWrapper, args: Record<string, unknown> | undefined) => {
  ...
  try {
    return asTextContentResult(
      await maybeFilter(jq_filter, await client.number3.salarytransactions.list(body)),
    );
  } catch (error) {
