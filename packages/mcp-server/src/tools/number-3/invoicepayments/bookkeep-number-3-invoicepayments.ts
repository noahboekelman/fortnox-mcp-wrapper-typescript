...
export const metadata: Metadata = {
  ...
  tags: [],
  httpMethod: 'put',
  httpPath: '/3/invoicepayments/{Number}/bookkeep',
  operationId: 'bookkeep',
};

export const tool: Tool = {
  name: 'bookkeep_number_3_invoicepayments',
  description:
...
export const handler = async (client: FortnoxMcpWrapper, args: Record<string, unknown> | undefined) => {
  ...
  try {
    return asTextContentResult(
      await maybeFilter(jq_filter, await client.number3.invoicepayments.bookkeep(Number, body)),
    );
  } catch (error) {
