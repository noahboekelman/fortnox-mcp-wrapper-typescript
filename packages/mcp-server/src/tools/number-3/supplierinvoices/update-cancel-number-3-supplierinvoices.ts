...
export const metadata: Metadata = {
  ...
  tags: [],
  httpMethod: 'put',
  httpPath: '/3/supplierinvoices/{GivenNumber}/cancel',
  operationId: 'cancel_6',
};

export const tool: Tool = {
  name: 'update_cancel_number_3_supplierinvoices',
  description:
...
export const handler = async (client: FortnoxMcpWrapper, args: Record<string, unknown> | undefined) => {
  ...
  try {
    return asTextContentResult(
      await maybeFilter(jq_filter, await client.number3.supplierinvoices.updateCancel(GivenNumber)),
    );
  } catch (error) {
