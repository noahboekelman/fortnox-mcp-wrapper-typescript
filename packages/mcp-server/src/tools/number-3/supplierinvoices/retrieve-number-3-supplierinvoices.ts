...
export const metadata: Metadata = {
  ...
  tags: [],
  httpMethod: 'get',
  httpPath: '/3/supplierinvoices/{GivenNumber}',
  operationId: 'get_48',
};

export const tool: Tool = {
  name: 'retrieve_number_3_supplierinvoices',
  description:
...
export const handler = async (client: FortnoxMcpWrapper, args: Record<string, unknown> | undefined) => {
  ...
  try {
    return asTextContentResult(
      await maybeFilter(jq_filter, await client.number3.supplierinvoices.retrieve(GivenNumber)),
    );
  } catch (error) {
