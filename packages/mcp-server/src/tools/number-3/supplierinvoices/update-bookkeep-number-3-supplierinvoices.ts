...
export const metadata: Metadata = {
  ...
  tags: [],
  httpMethod: 'put',
  httpPath: '/3/supplierinvoices/{GivenNumber}/bookkeep',
  operationId: 'bookkeep_4',
};

export const tool: Tool = {
  name: 'update_bookkeep_number_3_supplierinvoices',
  description:
...
export const handler = async (client: FortnoxMcpWrapper, args: Record<string, unknown> | undefined) => {
  ...
  try {
    return asTextContentResult(
      await maybeFilter(jq_filter, await client.number3.supplierinvoices.updateBookkeep(GivenNumber)),
    );
  } catch (error) {
