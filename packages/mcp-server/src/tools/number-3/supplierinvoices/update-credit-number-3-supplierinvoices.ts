...
export const metadata: Metadata = {
  ...
  tags: [],
  httpMethod: 'put',
  httpPath: '/3/supplierinvoices/{GivenNumber}/credit',
  operationId: 'credit_2',
};

export const tool: Tool = {
  name: 'update_credit_number_3_supplierinvoices',
  description:
...
export const handler = async (client: FortnoxMcpWrapper, args: Record<string, unknown> | undefined) => {
  ...
  try {
    return asTextContentResult(
      await maybeFilter(jq_filter, await client.number3.supplierinvoices.updateCredit(GivenNumber)),
    );
  } catch (error) {
