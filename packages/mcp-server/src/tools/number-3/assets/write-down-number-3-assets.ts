...
export const metadata: Metadata = {
  ...
  tags: [],
  httpMethod: 'put',
  httpPath: '/3/assets/writedown/{GivenNumber}',
  operationId: 'writeDown',
};

export const tool: Tool = {
  name: 'write_down_number_3_assets',
  description:
...
export const handler = async (client: FortnoxMcpWrapper, args: Record<string, unknown> | undefined) => {
  ...
  try {
    return asTextContentResult(
      await maybeFilter(jq_filter, await client.number3.assets.writeDown(GivenNumber, body)),
    );
  } catch (error) {
